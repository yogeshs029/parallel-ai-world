...
import { Users, CheckSquare, ArrowRight, Trash2 } from 'lucide-react';
...
export const WorldCard: React.FC<WorldCardProps> = ({ world, viewMode = 'grid', onWorldDeleted }) => {
            ...
            <div className={cn('h-14 w-full bg-gradient-to-r p-3.5 flex items-end justify-between', coverGradient)}>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  type="button"
                  onClick={handleDeleteClick}
                  className="p-1.5 rounded-lg bg-black/40 hover:bg-red-500 text-text-muted hover:text-white transition-colors cursor-pointer border border-white/10"
                  title="Delete World"
                >
